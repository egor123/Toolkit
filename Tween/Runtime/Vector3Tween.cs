...
namespace Lostbyte.Toolkit.Tween
{
    public class Vector3Tween : Tween
    {
        ...
        internal Vector3Tween(MonoBehaviour initiator, Action<Vector3> onChange) : base(initiator) { OnChange = onChange; }
        protected override void Init() => OnChange.Invoke(StartVector);
