...
namespace Lostbyte.Toolkit.Tween.TMP
{
    public class TextMeshProTween : Tween
    {
        ...
        internal TextMeshProTween(MonoBehaviour initiator, TMP_Text textMeshPro) : base(initiator) { _textMeshPro = textMeshPro; }
        internal string TargetText { private get; set; }
        protected override void Init() => _startText = _textMeshPro.text;
